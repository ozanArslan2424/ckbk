...
namespace Args {
  ...
  export type IngredientByRecipeIdGet =
    ExtractArgs<Models.IngredientByRecipeIdGet>;
...
class CorpusApi {
  ...
  public readonly endpoints = {
    ...
    ingredientIdPut: (p: Args.IngredientIdPut["params"]) =>
      `/api/ingredient/${String(p.id)}`,
    ...
    recipeIdPut: (p: Args.RecipeIdPut["params"]) =>
      `/api/recipe/${String(p.id)}`,
    ...
    cookbookIdGet: (p: Args.CookbookIdGet["params"]) =>
      `/api/cookbook/${String(p.id)}`,
    cookbookPost: "/api/cookbook",
    cookbookIdPut: (p: Args.CookbookIdPut["params"]) =>
      `/api/cookbook/${String(p.id)}`,
  };
