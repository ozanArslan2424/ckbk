...
class CorpusApi {
	...
	public _Get = async (args: Args._Get) => {
		const req = {
	...
	public healthGet = async (args: Args.HealthGet) => {
		const req = {
			endpoint: "/api/health",
			method: "GET",
			search: args.search,
	...
	public authMeGet = async (args: Args.AuthMeGet) => {
		const req = {
	...
	public authLoginPost = async (args: Args.AuthLoginPost) => {
		const req = {
	...
	public authRegisterPost = async (args: Args.AuthRegisterPost) => {
		const req = {
	...
	public authLogoutPost = async (args: Args.AuthLogoutPost) => {
		const req = {
	...
	public authRefreshPost = async (args: Args.AuthRefreshPost) => {
		const req = {
	...
	public authVerifyPost = async (args: Args.AuthVerifyPost) => {
		const req = {
	...
	public ingredientPost = async (args: Args.IngredientPost) => {
		const req = {
	...
	public ingredientIdPut = async (args: Args.IngredientIdPut) => {
		const req = {
	...
	public ingredientByRecipeIdGet = async (args: Args.IngredientByRecipeIdGet) => {
		const req = {
	...
	public materialPost = async (args: Args.MaterialPost) => {
		const req = {
	...
	public materialGet = async (args: Args.MaterialGet) => {
		const req = {
			endpoint: "/api/material",
			method: "GET",
			search: args.search,
	...
	public measurementPost = async (args: Args.MeasurementPost) => {
		const req = {
	...
	public measurementGet = async (args: Args.MeasurementGet) => {
		const req = {
			endpoint: "/api/measurement",
			method: "GET",
			search: args.search,
	...
	public recipePost = async (args: Args.RecipePost) => {
		const req = {
			endpoint: "/api/recipe",
			method: "POST",
			search: args.search,
	...
	public recipeIdPut = async (args: Args.RecipeIdPut) => {
		const req = {
	...
	public recipeGet = async (args: Args.RecipeGet) => {
		const req = {
			endpoint: "/api/recipe",
			method: "GET",
			search: args.search,
	...
	public recipePopularGet = async (args: Args.RecipePopularGet) => {
		const req = {
	...
	public recipeLikePost = async (args: Args.RecipeLikePost) => {
		const req = {
	...
	public stepPost = async (args: Args.StepPost) => {
		const req = {
			endpoint: "/api/step",
			method: "POST",
			search: args.search,
	...
	public stepIdPut = async (args: Args.StepIdPut) => {
		const req = {
	...
	public stepByRecipeIdGet = async (args: Args.StepByRecipeIdGet) => {
		const req = {
